# Contributing
redux-tale is an Open Source Project [licensed under the Apache 2.0 License](LICENSE).
We happily accept Pull Requests, so here are a few guidelines to get you started. 

## Getting Started

* Make sure you have a [GitHub account](https://github.com/signup/free)
* Submit [a ticket](https://github.com/saxobank/redux-tale/issues) for your issue, assuming one does not already exist.
